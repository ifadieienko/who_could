...
test("platform localization dictionaries stay complete", async () => {
  const en = (await import("../src/locales/en.js")).default;
  const pl = (await import("../src/locales/pl.js")).default;
  const ru = (await import("../src/locales/ru.js")).default;
